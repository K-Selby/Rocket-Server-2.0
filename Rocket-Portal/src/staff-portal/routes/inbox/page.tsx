...
import { CurrentUser, useCurrentUser } from "@/app/context/CurrentUserContext";
import { DayOffRequest, isRecent, useInbox } from "@/app/context/InboxContext";
    ...
    <section className={styles.review} aria-label="Team request review">
      ...
      <div className={styles.layout}>
        <aside className={styles.calendar}>
          ...
          <a href="/staff/diary">Open Staff Diary →</a>
        </aside>
    ...
    return (
      <section className="manager-section">
        ...
        <p>
          ...
          <Link href="/staff/manager">Manager → Staff Settings</Link>.
        </p>
      </section>
    );
  }
