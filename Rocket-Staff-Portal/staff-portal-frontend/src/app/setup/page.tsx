      ...
      <section className={`${styles.card} ${setupStyles.card}`}>
        ...
        {passwordStep ? (
          ...
          <div className={setupStyles.setupActions}>
            ...
            <button type="button" onClick={() => router.replace("/rota")}>Enter Staff Portal</button>
          </div>
          ...
          <form className={styles.form} onSubmit={startEmail}>
            ...
            <button type="button" className={setupStyles.secondaryAction} disabled={busy} onClick={() => router.replace("/rota")}>Skip for now</button>
          </form>
        )}
      </section>
    </main>
